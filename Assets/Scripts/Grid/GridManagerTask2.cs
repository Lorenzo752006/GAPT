...
public class GridManagerTask2 : MonoBehaviour
{
    public static GridManagerTask2 Instance { get; private set; }
    ...
    private void GenerateDefaultMap()
    {
        ...
        // Gap in wall for passage (3 wide: x = 6, 7, 8)
        grid[6, 7] = CellType.Floor;
        grid[7, 7] = CellType.Floor;
        grid[8, 7] = CellType.Floor;
        ...
        // Gap in wall (3 wide: y = 5, 6, 7)
        grid[14, 5] = CellType.Floor;
        grid[14, 6] = CellType.Floor;
        grid[14, 7] = CellType.Floor;

        // Gap / doorway (3 wide: x = 3, 4, 5)
        grid[3, 11] = CellType.Floor; 
        grid[4, 11] = CellType.Floor; 
        grid[5, 11] = CellType.Floor; 
    }
