...
public class GridPlayerControllerTask2 : MonoBehaviour
{
    [Header("Movement")]
    ...
    private void Start()
    {
        ...
        targetWorldPosition = GridManagerTask2.Instance.GridToWorld(gridPosition.x, gridPosition.y);
    ...
    private void TryMove(Vector2Int direction)
    {
        ...
        // Ask the GridManagerTask2 if the target cell is walkable
        if (GridManagerTask2.Instance.IsWalkable(targetGrid.x, targetGrid.y))
        {
